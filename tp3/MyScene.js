...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Wood Like (no ambient, no diffuse)
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0.51,0.29,0.043, 1.0);
        this.material4.setDiffuse(0.51,0.29,0.043, 1.0);
        this.material4.setSpecular(0.051,0.029,0.0043, 1.0);
